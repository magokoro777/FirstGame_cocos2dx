...
Scene* StageScene2::createScene()
{
    // 'scene' is an autorelease object
    auto scene = Scene::create();
    
    // 'layer' is an autorelease object
    auto layer = StageScene2::create();
...
bool StageScene2::init()
{
    ...
    //ボタンの生成（画像）
     ...
     auto pBtnItem1 = MenuItemImage::create("images/btn1.png","images/btn1.png", CC_CALLBACK_1(StageScene2::addPlayer, this));
     auto pBtnItem2 = MenuItemImage::create("images/btn2.png","images/btn2.png", CC_CALLBACK_1(StageScene2::addPlayer2, this));
     auto pBtnItem3 = MenuItemImage::create("images/btn3.png","images/btn3.png", CC_CALLBACK_1(StageScene2::addPlayer3, this));
     ...
     //一時停止ボタン
     auto pauseButton = MenuItemImage::create("images/pause.png","images/pause.png", CC_CALLBACK_1(StageScene2::Pause, this));
     ...
     //メニューボタン
     auto menuButton = MenuItemImage::create("images/menu.png","images/menu.png", CC_CALLBACK_1(StageScene2::Menubtn, this));
...
//定期的に高速に呼ばれる関数
void StageScene2::update(float delta)
 {
    log("update");
...
void StageScene2::createInitObjects()
{
	auto listener = EventListenerTouchAllAtOnce::create();
	    listener->onTouchesMoved = CC_CALLBACK_2(StageScene2::onTouchedMoved, this);
...
void StageScene2::addPlayer(Ref * sender)
{
	//プレイヤーの追加
...
void StageScene2::addPlayer2(Ref * sender)
{
	//プレイヤーの追加
...
void StageScene2::addPlayer3(Ref * sender)
{
	//プレイヤーの追加
...
void StageScene2::collisionChecker()		//ユニット同士の衝突判定
{
	//プレイヤーの敵との衝突判定
...
void StageScene2::collisionChecker2()		//ユニットと領地の衝突判定
{
	//プレイヤーユニットと敵領地の衝突判定
	for(UnitSprite * playerArray : playerVect){
...
void StageScene2::calcDamage(UnitSprite *attacker, TowerSprite* target)	//プレイヤーユニットと敵領地
{
			//サウンド再生
			//パーティクルを出す
...
void StageScene2::calcDamage2(UnitSprite *attacker, TowerSprite* target)	//敵ユニットとプレイヤー領地
{
			target->setHp(target->getHp() - attacker->getAttack());
			if(target->getHp() <= 0){
				auto delay = DelayTime::create(3.0);
...
void StageScene2::Pause(Ref* pSender)
{
	pause = !pause;
	if(pause == true)
...
void StageScene2::Menubtn(Ref* pSender)
{
	menu = !menu;
	if(menu == true){
		Director::getInstance()->pause();
...
void StageScene2::onTouchedMoved(const std::vector<cocos2d::Touch*>& touches, cocos2d::Event *pEvent)
{
//	log("onTouchedMoved");
